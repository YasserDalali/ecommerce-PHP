...
<div id="sidebar" class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px; height: 92vh;">
  ...
  <ul class="nav nav-pills flex-column mb-auto">
    ...
    <li>
      <a href="index.php?action=dashboard&table=charts" class="nav-link link-dark">
        <i class="fas fa-tachometer-alt me-2"></i>
        Dashboard
      </a>
    </li>
    <li>
      <a href="index.php?action=dashboard&table=orders" class="nav-link link-dark">
        <i class="fas fa-shopping-cart me-2"></i>
        Orders
      </a>
    </li>
    <li>
      <a href="index.php?action=dashboard&table=products" class="nav-link link-dark">
        <i class="fas fa-box-open me-2"></i>
        Products
      </a>
    </li>
    <li>
      <a href="index.php?action=dashboard&table=customers" class="nav-link link-dark">
